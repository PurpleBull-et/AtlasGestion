...
class EntradaBodega(models.Model):
    ...
    producto = models.ForeignKey(Producto, on_delete=models.CASCADE)  # Relación obligatoria
    cantidad_recibida = models.PositiveIntegerField()
    proveedor = models.ForeignKey(Proveedor, on_delete=models.CASCADE)  # Relación obligatoria
